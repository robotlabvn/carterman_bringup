...
#endif
    // set velocity Speed "!S <Channel> <Speed Value>" 
...
//  controller.write("^RWD 250\r");
  ...
  // set motor operating mode (1 Open Loop)
  if (open_loop)
  {
   ...
   // set motor operating mode (6 for closed-loop speed position)
  {
...
//  controller.write("^MXRPM 2 82\r");
  controller.write("^MXRPM 1 500\r");
  controller.write("^MXRPM 2 500\r");
...
//  controller.write("^MAC 2 2000\r");
  ...
  // set PID for FOC parameters (gain * 10)
  // controller.write("^KPF 1 10\r");
  // controller.write("^KPF 2 10\r");
  // controller.write("^KIF 1 5\r");
  // controller.write("^KIF 2 5\r");
  // controller.write("^KD 1 0\r");
  // controller.write("^KD 2 0\r");

   // set PID  parameters (gain * 10)
  controller.write("^KP 1 15\r");
  controller.write("^KP 2 16\r");
  controller.write("^KI 1 3\r");
  controller.write("^KI 2 3\r");
  controller.write("^KD 1 2\r");
  controller.write("^KD 2 2\r");

  // set Brushless operation Mode with (1-Sinuoidal) 
  controller.write("^BMOD 1 1\r");
  controller.write("^BMOD 2 1\r");
  
  //set brushless feedback with Hall sensors
  controller.write("^BFBK 1 1\r");
  controller.write("^BFBK 2 1\r");
  
  //set the number og Poles Pairs of BLDC
  controller.write("^BPOL 1 -15\r");
  controller.write("^BPOL 2 -15\r");

  /*=set encoder counts (ppr)
  std::stringstream right_enccmd;
  std::stringstream left_enccmd;
  right_enccmd << "?BS 1" << encoder_ppr << "\r";
  left_enccmd << "?BS 2" << encoder_ppr << "\r";
...
#endif
      // BCR= is Brushless counts Relatives
      if ( odom_buf[0] == 'B' && odom_buf[1] == 'C' && odom_buf[2] == 'R' && odom_buf[3] == '='  )
      {
        int delim;
        //for ( delim = 4; delim < odom_idx; delim++ ) // default
